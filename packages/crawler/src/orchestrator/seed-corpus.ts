...
export const CURATED_SEED_CORPUS: SeedCategory[] = [
  ...
  },
  {
    ...
    description: 'Generative AI, Large Language Models, ChatGPT, Claude, Gemini, GPUs, and robotics.',
    seeds: [
      {
        url: 'https://en.wikipedia.org/wiki/Large_language_model',
        title: 'Wikipedia — Large Language Models',
        description: 'Large language models, LLMs, transformer architectures, GPT, prompt engineering, and generative AI.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'ChatGPT conversational chatbot developed by OpenAI, based on GPT architecture.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Generative artificial intelligence, text-to-image, Midjourney, DALL-E, audio synthesis, and foundation models.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Robotics, autonomous machines, humanoid robots, industrial automation, and sensor systems.',
        priority: 2,
      ...
      },
      {
        ...
        description: 'Computer vision, image recognition, convolutional neural networks, object detection, and autonomous driving.',
        priority: 2,
  ...
  },
  {
    ...
    description: 'Weather, maps, currency conversion, time zones, calendars, and everyday utilities.',
    seeds: [
      {
        url: 'https://en.wikipedia.org/wiki/Weather_forecasting',
        title: 'Wikipedia — Weather Forecasting',
        description: 'Meteorology, weather forecasts, radar, climate models, temperature, and atmospheric pressure.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'GPS satellite navigation, digital mapping, geographic coordinates, and navigation systems.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Electronic calculators, arithmetic operations, scientific computation, and calculating devices.',
        priority: 2,
      ...
      },
      {
        ...
        description: 'Coordinated Universal Time (UTC), standard time zones, daylight saving time, and world clock.',
        priority: 2,
    ...
    seeds: [
      {
        ...
        description: 'Culinary techniques, recipes, baking, grilling, boiling, frying, and flavor preparation.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'History of pizza, Neapolitan pizza, crust styles, toppings, cheese, and Italian cuisine.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Coffee beans, espresso, roasting, brewing methods, latte, cappuccino, and caffeine.',
        priority: 1,
      ...
      },
      {
        ...
        title: 'Wikipedia — Tea',
        description: 'Green tea, black tea, herbal tea, chai, tea culture, health benefits, and brewing.',
        priority: 2,
  ...
  },
  {
    ...
    description: 'Stock market, mutual funds, personal budgeting, credit cards, banking, and real estate.',
    seeds: [
      {
        url: 'https://en.wikipedia.org/wiki/Stock_market',
        title: 'Wikipedia — Stock Market & Investing',
        description: 'Stock exchanges, equities, trading, NASDAQ, NYSE, S&P 500, dividends, and portfolio investing.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Budgeting, savings accounts, emergency funds, debt management, retirement planning, and investing.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Credit scores, reward points, interest rates, debit cards, loans, and modern banking.',
        priority: 2,
      ...
      },
      {
        ...
        description: 'Property buying, mortgages, real estate investment, home ownership, and renting.',
        priority: 2,
    ...
    seeds: [
      {
        ...
        description: 'Global travel, sightseeing, flights, hotels, eco-tourism, backpacking, and trip planning.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Commercial aviation, flight booking, international airports, passenger travel, and airliners.',
        priority: 2,
      ...
      },
      {
        ...
        description: 'Tokyo city guide, Japanese culture, districts, transport, landmarks, and technology hub.',
        priority: 2,
      ...
      },
      {
        ...
        description: 'New York City history, boroughs, Manhattan, culture, finance, Broadway, and landmarks.',
        priority: 2,
      ...
      },
      {
        ...
        description: 'Paris city guide, Eiffel Tower, Louvre, fashion, French cuisine, and historical monuments.',
        priority: 2,
  ...
  },
  {
    ...
    description: 'Resume writing, job searching, remote work, interviews, productivity, and project management.',
    seeds: [
      {
        url: 'https://en.wikipedia.org/wiki/Resume',
        title: 'Wikipedia — Resume & CV Writing',
        description: 'Curriculum vitae, job applications, resume formatting, cover letters, and career presentation.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Working from home, distributed teams, hybrid work models, and digital nomad lifestyle.',
        priority: 2,
      ...
      },
      {
        ...
        description: 'Productivity systems, Pomodoro technique, task management, focus, and workflow efficiency.',
        priority: 2,
  ...
  },
  {
    ...
    description: 'React, Vue, Angular, Next.js, Tailwind CSS, SQL, and modern web engineering tools.',
    seeds: [
      {
        url: 'https://en.wikipedia.org/wiki/React_(software)',
        title: 'Wikipedia — React JavaScript Library',
        description: 'React declarative component-based UI library developed by Meta for web and native apps.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Next.js React framework with server-side rendering, static generation, and full-stack capabilities.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'SQL relational database querying, schema design, indexes, joins, and transactions.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Representational State Transfer (REST), HTTP methods, endpoints, JSON, and web services.',
        priority: 2,
    ...
    seeds: [
      {
        ...
        description: 'Mobile operating systems, touchscreen displays, processors, camera sensors, and 5G networks.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Android mobile operating system developed by Google, APKs, Google Play, and open-source ecosystem.',
        priority: 1,
      ...
      },
      {
        ...
        description: 'Apple iOS mobile operating system for iPhone, iPadOS, App Store, and Apple silicon.',
        priority: 1,
