...
export const BANG_CATALOG: BangDefinition[] = [
  ...
  },
  {
    ...
    category: 'developer',
    urlTemplate: 'https://github.com/search?type=repositories&q={q}',
  },
  {
    key: 'gist',
    name: 'GitHub Gists',
    category: 'developer',
    urlTemplate: 'https://gist.github.com/search?q={q}',
  },
  {
    key: 'gl',
    aliases: ['gitlab'],
    name: 'GitLab',
    category: 'developer',
    urlTemplate: 'https://gitlab.com/search?search={q}',
  },
  {
    key: 'bb',
    aliases: ['bitbucket'],
    name: 'Bitbucket',
    category: 'developer',
    urlTemplate: 'https://bitbucket.org/repo/all?name={q}',
  },
  {
    key: 'so',
  ...
  },
  {
    ...
    name: 'Hacker News',
    category: 'developer',
    urlTemplate: 'https://hn.algolia.com/?q={q}',
  },
  {
    key: 'r',
    aliases: ['reddit'],
  ...
  },
  {
    ...
    name: 'Dev.to',
    category: 'developer',
    urlTemplate: 'https://dev.to/search?q={q}',
  },
  {
    key: 'hashnode',
    name: 'Hashnode',
    category: 'developer',
    urlTemplate: 'https://hashnode.com/search?q={q}',
  },
  {
    key: 'hf',
    aliases: ['huggingface'],
    name: 'Hugging Face',
    category: 'developer',
    urlTemplate: 'https://huggingface.co/models?search={q}',
  },
  ...
  },
  {
    ...
    name: 'PyPI',
    category: 'packages',
    urlTemplate: 'https://pypi.org/search/?q={q}',
  },
  {
    key: 'cargo',
    aliases: ['crates'],
    name: 'Crates.io',
    category: 'packages',
    urlTemplate: 'https://crates.io/search?q={q}',
  },
  {
    key: 'pkg',
    aliases: ['godoc'],
    name: 'Go Packages',
    category: 'packages',
    urlTemplate: 'https://pkg.go.dev/search?q={q}',
  },
  {
    key: 'rubygems',
    aliases: ['gem'],
    name: 'RubyGems',
    category: 'packages',
    urlTemplate: 'https://rubygems.org/search?query={q}',
  },
  {
    key: 'packagist',
    aliases: ['composer'],
    name: 'Packagist',
    category: 'packages',
    urlTemplate: 'https://packagist.org/?query={q}',
  },
  {
    key: 'nuget',
    name: 'NuGet',
    category: 'packages',
    urlTemplate: 'https://www.nuget.org/packages?q={q}',
  },
  {
    key: 'maven',
    name: 'Maven Central',
    category: 'packages',
    urlTemplate: 'https://search.maven.org/search?q={q}',
  },
  {
    key: 'dh',
    aliases: ['docker'],
    name: 'Docker Hub',
    category: 'packages',
    urlTemplate: 'https://hub.docker.com/search?q={q}',
  },
  ...
  // ── Documentation & Specs ──
  {
    ...
    name: 'MDN Web Docs',
    category: 'docs',
    urlTemplate: 'https://developer.mozilla.org/search?q={q}',
  },
  {
    key: 'caniuse',
    aliases: ['ciu'],
    name: 'Can I Use',
    category: 'docs',
    urlTemplate: 'https://caniuse.com/?search={q}',
  },
  { key: 'devdocs', name: 'DevDocs', category: 'docs', urlTemplate: 'https://devdocs.io/#q={q}' },
  {
    ...
    category: 'docs',
    urlTemplate: 'https://doc.rust-lang.org/std/?search={q}',
  },
  {
    key: 'docsrs',
    name: 'Docs.rs',
    category: 'docs',
    urlTemplate: 'https://docs.rs/releases/search?query={q}',
  },
  {
    key: 'ts',
    aliases: ['typescript'],
    ...
    category: 'docs',
    urlTemplate: 'https://www.typescriptlang.org/search?q={q}',
  },
  {
    key: 'py',
    aliases: ['pydoc'],
    name: 'Python Docs',
    category: 'docs',
    urlTemplate: 'https://docs.python.org/3/search.html?q={q}',
  },
  {
    key: 'cpp',
    aliases: ['cppreference'],
    name: 'CppReference',
    category: 'docs',
    urlTemplate: 'https://en.cppreference.com/mwiki/index.php?search={q}',
  },
  {
    key: 'arch',
    aliases: ['archwiki'],
    name: 'ArchWiki',
    category: 'docs',
    urlTemplate: 'https://wiki.archlinux.org/index.php?search={q}',
  },
  {
    key: 'man',
    name: 'ManKier Linux Manuals',
    category: 'docs',
    urlTemplate: 'https://www.mankier.com/?q={q}',
  },
  {
    key: 'rfc',
    name: 'IETF RFCs',
    category: 'docs',
    urlTemplate: 'https://datatracker.ietf.org/doc/search/?name={q}',
  },
  {
    key: 'w3c',
    name: 'W3C Specifications',
    category: 'docs',
    urlTemplate: 'https://www.w3.org/TR/?title={q}',
  },
  ...
  // ── Security & Infrastructure ──
  {
    ...
    category: 'security',
    urlTemplate:
      'https://nvd.nist.gov/vuln/search/results?form_type=Basic&results_type=overview&query={q}',
  },
  {
    key: 'exploit',
    aliases: ['edb'],
    name: 'Exploit-DB',
    category: 'security',
    urlTemplate: 'https://www.exploit-db.com/search?q={q}',
  },
  {
    key: 'crt',
    aliases: ['ct'],
    ...
    category: 'security',
    urlTemplate: 'https://crt.sh/?q={q}',
  },
  {
    key: 'whois',
    name: 'Whois Lookup',
    category: 'security',
    urlTemplate: 'https://www.whois.com/whois/{q}',
  },
  {
    key: 'dns',
    name: 'DNS Checker',
    category: 'security',
    urlTemplate: 'https://dnschecker.org/#A/{q}',
  },
  {
    key: 'shodan',
    name: 'Shodan Search',
    category: 'security',
    urlTemplate: 'https://www.shodan.io/search?query={q}',
  },
  ...
  },
  {
    ...
    name: 'Wiktionary',
    category: 'reference',
    urlTemplate: 'https://en.wiktionary.org/wiki/Special:Search?search={q}',
  },
  {
    key: 'arxiv',
    name: 'arXiv Papers',
    category: 'reference',
    urlTemplate: 'https://arxiv.org/search/?query={q}&searchtype=all',
  },
  {
    key: 'scholar',
    name: 'Google Scholar',
  ...
  },
  {
    ...
    name: 'Wolfram Alpha',
    category: 'reference',
    urlTemplate: 'https://www.wolframalpha.com/input?i={q}',
  },
  {
    key: 'archive',
    aliases: ['wb', 'wayback'],
  ...
  },
  {
    ...
    name: 'OpenStreetMap',
    category: 'general',
    urlTemplate: 'https://www.openstreetmap.org/search?query={q}',
  },
  {
    key: 'tw',
    aliases: ['twitter', 'x'],
    name: 'X / Twitter',
    category: 'general',
    urlTemplate: 'https://twitter.com/search?q={q}',
  },
];
